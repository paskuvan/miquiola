...
export const PIEZAS = [
  {
    slug: 'cuenco-ceniza-01',
    nombre: 'Cuenco ceniza',
    subtitulo: 'Gres con esmalte ceniza volcánica',
    precio: 28000,
    disponible: true,
    unidades: 1,
    moods: ['cocina-calida', 'mesa-desnuda'],
    imagenes: ['/placeholders/pieza-01-a.jpg', '/placeholders/pieza-01-b.jpg'],
    paleta: ['#C4B8A8', '#8E7E6E', '#F0EBE3'],
    descripcion: 'Modelado a mano, cada cuenco guarda las huellas del proceso. El esmalte de ceniza volcánica se funde a 1280°C creando superficies únicas que no se repiten.',
    dimensiones: '12 cm diámetro · 6 cm alto',
    cuidado: 'Apto lavavajillas. No microondas.',
    proceso: 'Modelado a mano → Biscocido → Esmaltado → Horneado a alta temperatura',
  },
  {
    ...
    unidades: 3,
    moods: ['cocina-calida'],
    imagenes: ['/placeholders/pieza-02-a.jpg', '/placeholders/pieza-02-b.jpg'],
  ...
  },
  {
    ...
    imagenes: ['/placeholders/pieza-03-a.jpg', '/placeholders/pieza-03-b.jpg'],
  ...
  },
  {
    ...
    imagenes: ['/placeholders/pieza-04-a.jpg', '/placeholders/pieza-04-b.jpg'],
